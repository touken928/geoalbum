  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200/50">
        ...
        <button
          onClick={onClose}
          className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100/50 rounded"
        >
          <X className="w-5 h-5" />
        </button>
      </div>
      ...
      <div className="flex items-center justify-between p-4 border-t border-gray-200/50">
        ...
        <div className="flex space-x-2">
          <button
            onClick={onClose}
            className="px-4 py-2 text-gray-700 bg-gray-100/80 rounded hover:bg-gray-200/80"
          >
            {allSuccess ? '完成' : '取消'}
          </button>
